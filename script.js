...
const TRANSLATIONS = {
  ...
  "nav-newsletter":    { en: "Newsletter",              fr: "Newsletter" },
  "newsletter-title":  { en: "NEWSLETTER",              fr: "NEWSLETTER" },
  "newsletter-intro":  { en: "Subscribe to get notified when I add a new project or reach a milestone. No spam — only real updates.", fr: "Abonne-toi pour être notifié quand j'ajoute un projet ou franchis une étape. Pas de spam — uniquement de vraies mises à jour." },
  "newsletter-form-title": { en: "Subscribe",          fr: "S'abonner" },
  "newsletter-form-send":  { en: "Subscribe",          fr: "S'abonner" },
  ...
  "about-p2":          { en: "I design custom PCBs with KiCad, program microcontrollers (RP2040, ESP32) in C/C++ and microython, and build everything from macropads to robotic arms controlled by AI. I got my BIA (Aeronautics Initiation Diploma) in 2024 and I'm aiming for ISAE-SUPAERO.", fr: "Je conçois des PCBs avec KiCad, programme des microcontrôleurs (RP2040, ESP32) en C/C++ et micropython, et construis tout, des macropads jusqu'aux bras robotiques contrôlés par IA. J'ai obtenu mon BIA en 2024 et vise l'ISAE-SUPAERO." },
